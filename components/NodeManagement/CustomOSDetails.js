...
export default () => {
    ...
    const handleChange = (event) => {
        ...
        if (event.target.value === 1) {
            ...
            Context._currentValue.AWSServiceType = "api"
        }
        else if (event.target.value === 2) {

            Context._currentValue.AWSServiceType = "ecs"
        }
    };
                        ...
                        <Grid item xs={12}>
                            <Grid item xs={12} align="center">
                                <form onSubmit={onSubmit}>
                                    ...
                                    <TextField  fullWidth type="password" className={classes.textField} variant="filled" size="small" label="Access Key ID" onChange={event => Context._currentValue.AWSAccessKeyID = event.target.value} />

                                    {location.security === "yes" ? <TextField  fullWidth type="password" className={classes.textField} variant="filled" size="small" label="Secret Access Key" onChange={event => Context._currentValue.AWSSecretAccessKey = event.target.value} /> : null}
