                         ...
                         <Grid item xs={12}>
                            <Grid item xs={12} align="center">
                                <form onSubmit={onSubmit}>
                                    <h4>Service Account JSON Credentials</h4>

                                    {location.security === "yes" ? <TextField required className={classes.textField} id="outlined-multiline-static"
                                        multiline
                                        rows={17}
                                        variant="outlined" onChange={event => Context._currentValue.GCPServiceAccountJSONCredentials = event.target.value} /> : null }
