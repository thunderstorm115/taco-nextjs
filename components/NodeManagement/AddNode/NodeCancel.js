        ...
        loading ? <Spinner /> :
            <main className={classes.layout}>
                ...
                <Paper className={classes.paper}>
                    ...
                    >
                        <Grid item xs={12}>
                            <h3 align="center">Thank you for your trial signup. An Obsidian representative will be in contact with you soon!</h3>
                        </Grid>
                    </Grid>
                    ...
                    >
                        <Grid item xs={12}>
                        <Button className={classes.yesButton} onClick={() => { history.push("/nodeManagement") }}>HOME</Button>
                        </Grid>
                    </Grid>
                </Paper>
            </main>
