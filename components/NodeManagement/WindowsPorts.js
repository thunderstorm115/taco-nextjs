                                        ...
                                        <MuiThemeProvider theme={theme1}>
                                            <FormControl component="fieldset">
                                                <FormGroup aria-label="position" row>
                                                    ...
                                                    <FormControlLabel
                                                        value="port5985"
                                                        control={<Checkbox className={classes.checkBox}  onChange={event => Context._currentValue.TCPPort5985 = event.target.checked}/>}
                                                        label="You opened TCP Port 5985"
                                                        labelPlacement="end"
                                                    />
                                                </FormGroup>
                                            </FormControl>
                                        ...
                                        <MuiThemeProvider theme={theme1}>
                                            <FormControl component="fieldset">
                                                ...
                                                <FormGroup aria-label="position" row>
                                                    <FormControlLabel
                                                        value="port5986"
                                                        control={<Checkbox className={classes.checkBox}  onChange={event => Context._currentValue.TCPPort5986 = event.target.checked}/>}
                                                        label="You opened TCP Port 5986"
                                                        labelPlacement="end"
