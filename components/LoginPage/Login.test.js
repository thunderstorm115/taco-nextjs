...
describe("test test", () => {
    it("renders data test", () => {
            const wrapper = shallow(<div>hi there</div>);
...
describe('myRender', () => {
    it('should render', () => {
        const theApp = shallow(<Account><Login /></Account>);

        expect(theApp.isEmptyRender()).toBe(false)
    });
});


describe('Button', () => {
    it('should render a styled buton', () => {
      const wrapper = (<Account><Login /></Account>);
